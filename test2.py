...
class LoginFormTest(LiveServerTestCase):
	...
	def testform(self):
		...
		unique = driver.find_element_by_name('unique')
		bprice = driver.find_element_by_name('bprice')
		sprice = driver.find_element_by_name('sprice')
		...
		sprice.send_keys(13)
		submit.send_keys(Keys.RETURN)
		assert 'already' in driver.page_source
